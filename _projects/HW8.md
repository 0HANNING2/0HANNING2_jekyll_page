...
```
<vegachart schema-url="https://0HANNING2.github.io/0HANNING2_jekyll_page/assets/json/viz1.json" style="width: 100%"></vegachart>
```
...
```
<vegachart schema-url="https://0HANNING2.github.io/0HANNING2_jekyll_page/assets/json/viz2.json" style="width: 100%"></vegachart>
```
