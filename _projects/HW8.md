...
<div class="left">
  {% include elements/button.html link="https://github.com/yourusername/yourrepository/path/to/data.csv" text="The Data" %}
</div>

<div class="right">
  {% include elements/button.html link="https://github.com/yourusername/yourrepository/path/to/notebook.ipynb" text="The Analysis" %}
</div>
